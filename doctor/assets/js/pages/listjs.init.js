...
var isValue = (isCount = new DOMParser().parseFromString(
  ...
  idField = document.getElementById("time"),
  customerNameField = document.getElementById("date"),
  emailField = document.getElementById("patient_name"),
  dateField = document.getElementById("service"),
  phoneField = document.getElementById("doctor"),
