    ...
    if (in_array($fileType, $allowedTypes)) {
        ...
        if (move_uploaded_file($_FILES['document']['tmp_name'], $targetFilePath)) {
            try {
                ...
                // Update the document_path for the given appointment ID in the appointment table
                ...
                $stmt = $pdo->prepare("INSERT INTO medical_records (patient_id, appointment_id, doctor_id, document_path, record_date, created_at) 
                                       VALUES (:patient_id, :appointment_id, :doctor_id, :document_path, NOW(), NOW())");
                $stmt->execute([
                ...
                echo "<p class='text-success'>File uploaded, path updated, and medical record created successfully.</p>";
                // Trigger printing after submission
