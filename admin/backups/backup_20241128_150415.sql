...
INSERT INTO `appointment` (id, service_id, patient_id, appointment_date, appointment_slot_id, appointment_time, doctor_id, department_id, selectedPayment, medical, status, paid, date_added, is_archive) VALUES ('58', '1', '10', '2024-11-25', '2', '15:02', '0', '0', '3', 'fracture', 'Pending', 'Pending', '2024-11-28 08:02:28', '0');
...
INSERT INTO `appointment_slots` (id, schedule, date, slot, is_archive) VALUES ('2', 'Afternoon', '2024-11-25 00:00:00.000000', '80', '0');
...
INSERT INTO `logs` (id, action, user, timestamp, details, is_archive) VALUES ('19', 'add appointment', '10', '2024-11-28 15:02:28', 'Appointment booked with ID: 58 for patient ID: 10', '0');
INSERT INTO `logs` (id, action, user, timestamp, details, is_archive) VALUES ('20', 'add appointment error', '10', '2024-11-28 15:02:28', 'Error booking appointment for patient ID: 10 - SQLSTATE[23000]: Integrity constraint violation: 4025 CONSTRAINT `medical_records.content` failed for `triolab_db`.`medical_records`', '0');
