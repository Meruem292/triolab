...
if (isset($_POST['add_doctor'])) {
    ...
    if ($checkQuery->rowCount() > 0) {
        ...
        $insertQuery = $pdo->prepare("INSERT INTO doctor (employee_id, firstname, lastname, username, email, password, department) VALUES (:employee_id, :firstname, :lastname, :username, :email, :password, :department)");
...
if (isset($_POST['edit_doctor'])) {
    ...
    $updateQuery = $pdo->prepare("UPDATE doctor SET firstname = :firstname, lastname = :lastname, email = :email, username = :username, department = :department WHERE employee_id = :id");
...
if (isset($_POST['archive_doctor'])) {
    ...
    $archiveQuery->bindParam(':id', $doctorIdDelete);
...
<body style="background-color: #F2FFF1">
                                                                        ...
                                                                        <td>
                                                                            <div class="dropdown d-inline-block">
                                                                                ...
                                                                                <ul class="dropdown-menu dropdown-menu-end">
                                                                                    <li>
                                                                                        <a href="#" class="dropdown-item remove-item-btn edit-btn" data-bs-toggle="modal" data-bs-target="#editDoctor" data-doctor-id="<?= $row['employee_id'] ?>" data-doctor-firstname="<?= $row['firstname'] ?>" data-doctor-lastname="<?= $row['lastname'] ?>" data-doctor-email="<?= $row['email'] ?>" data-doctor-username="<?= $row['username'] ?>" data-doctor-department="<?= $row['department'] ?>">
                                                                                            <i class="ri-edit-fill align-bottom me-2 text-muted"></i> Update
                                                                                        </a>
                                                                                    </li>
                                                                                    <li>
                                                                                        <a href="#" class="dropdown-item remove-item-btn archive-btn" data-bs-toggle="modal" data-bs-target="#archiveDoctor" data-doctor-id="<?= $row['employee_id'] ?>">
    ...
    <!-- ADD DOCTOR -->
    <div id="addDoctor" class="modal fade" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <form method="POST" class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Add Doctor Information</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="employee_id" value="<?= generateEmployeeID('TRLB') ?>" readonly required placeholder="eg. Chest, Pelvic, BPS">
                    </div>
                    <div class="mb-3">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <form method="POST" class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <label class="form-label">Employee ID <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" name="employee_id" id="doctorId" readonly required placeholder="eg. Chest, Pelvic, BPS">
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Username <span class="text-danger">*</span></label>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <form method="POST" class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p>Are you sure you want to archive this doctor?</p>
                </div>
                <div class="modal-footer">
    ...
    <script>
        ...
        editButtons.forEach(function(button) {
            button.addEventListener('click', function() {
                ...
                var doctorFirstname = this.getAttribute('data-doctor-firstname');
                var doctorLastname = this.getAttribute('data-doctor-lastname');
                var doctorEmail = this.getAttribute('data-doctor-email');
                var doctorUsername = this.getAttribute('data-doctor-username');
                var doctorDepartment = this.getAttribute('data-doctor-department');

                document.getElementById('doctorId').value = doctorId;
                document.getElementById('doctorFirstname').value = doctorFirstname;
                document.getElementById('doctorLastname').value = doctorLastname;
                document.getElementById('doctorEmail').value = doctorEmail;
                document.getElementById('doctorUsername').value = doctorUsername;
                document.getElementById('doctorDepartment').value = doctorDepartment;
            });
        });
    </script>
