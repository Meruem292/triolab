<footer class="footer-2 mt-80">
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="widget widget-about">
                        ...
                        <p class="mt-20 footer-text">Triolab Diagnostics and Medical Clinic: Your health, our priority. Quality healthcare, personalized service.</p>
                        <hr class="mt-30 mb-30 bg-white" />
                        <h5 class="heading font-bold text-white">Reach Out</h5>
                        <ul class="contact footer-text">
                            <li>
                                <i class="ion-location-outline"></i>
                                <div>
                                    <strong>Triolab Diagnostic and Medical Clinic</strong>
                                    <br>
                                    Located at Brgy. H2, Dasmarinas City, Cavite in front of Aqua JST/Motolite.
                                </div>
                            </li>
                            <li><i class="ion-call-outline"></i> (046) 894 3619 | 0938 453 8273</li>
                            <li><i class="ion-mail-outline"></i> triolabgly2023@gmail.com</li>
                        </ul>
                ...
                <div class="col-lg-4">
                    <div class="widget widget-links">
                        <h5 class="heading font-bold text-white">Services Offered</h5>
                        <ul>
                            <li><a class="text-white" href="javascript:void(0)">Pre-Employment Tests</a></li>
                            <li><a class="text-white" href="javascript:void(0)">Laboratory Tests</a></li>
                            <li><a class="text-white" href="javascript:void(0)">Consultation</a></li>
                            <li><a class="text-white" href="javascript:void(0)">Ultrasound</a></li>
                            <li><a class="text-white" href="javascript:void(0)">X-Ray</a></li>

                        </ul>
                    </div>
                    <hr class="mt-30 mb-30 bg-white" />
                    <h5 class="heading font-bold text-white">Social Connect</h5>
                    <ul class="social social-round social-2x">
                        <li><a class="facebook" href="https://www.facebook.com/profile.php?id=61558234075489"><i class="ion-logo-facebook"></i></a></li>
                ...
                <div class="col-lg-4">
                    <div class="widget widget-timings">
                        <h5 class="heading font-bold ">Operation Hours</h5>
                    ...
                    <hr class="mt-30 mb-30 bg-white" />
                    <div class="widget widget-links">
                        <h5 class="heading font-bold text-white">Quick Links</h5>
                        <ul>
                            <li><a class="text-white" href="#inquiries">FAQs</a></li>
                            <li><a class="text-white" data-bs-toggle="modal" data-bs-target="#privacyModal">Privacy Policy</a></li>
                    ...
                    <div class="widget widget-pay">
                        ...
                        <ul class="payment-list">
                            <li class="item">
                                <img src="assets/images/gcash.jpg" style="width: 100px; height: 50px;" alt="">
                            </li>
                            <!-- <li class="item">
                                <img src="assets/images/maya.jpg" style="width: 100px; height: 50px; object-fit: cover;" alt="">
                            </li> -->
                            <li class="item">
                                <img src="assets/images/cash.jpg" style="width: 100px; height: 50px; object-fit: cover;" alt="">
                            </li>
                        </ul>
                    </div>
                </div>
    ...
    <div class="footer-sec">
        <div class="container">
            <p class="mb-0 footer-text text-lg-center text-center">&copy; 2024 All Rights Reserved.
                <a href="index.php" class="font-semi-bold text-success">Triolab Diagnostic and Medical Clinic</a>
            </p>
        </div>
    </div>
</footer>
